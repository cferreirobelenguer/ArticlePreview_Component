...
import autorImage from '../assets/images/avatar-michelle.jpg'
    ...
    return(
        <article className="card_container">
            <div className='card_imagen'>
                <img src={cardImage}  alt="" className="img-fluid" id="imageCard"></img>
            </div>
            <div className="card_text">
                ...
                <div className="card_subtitle">
                    <p>Perhaps ever been in a room and felt like something was missing?
                    Perhaps it felt slightly bare and uninviting. I've got some
                    simple tips to help tou make any room feel complete.</p>
                </div>
                
                    {
                    //When show state is false it shares autor div
                    show===false &&
                        <div className="card_autor">
                            <div className="card_imageAutor">
                                <img src={autorImage} width="30" height="30" alt="" className='img-fluid' id="imagenAutor"></img>
                            </div>
                            <div className="card_autoTitle">
                                <div>
                                    <h6 className="title">&nbsp; &nbsp;Michele Appleton</h6>
                                </div>
                                <div className="card_autoSubtitle">
                                    <p className="subtitle">&nbsp; &nbsp; 28 Jun 2020</p>
                                </div>
                            </div>
                            <div className="card_autoButton">
                                <button className="buttonShare" onClick={handlerClick}><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path fill="#6E8098" d="M15 6.495L8.766.014V3.88H7.441C3.33 3.88 0 7.039 0 10.936v2.049l.589-.612C2.59 10.294 5.422 9.11 8.39 9.11h.375v3.867L15 6.495z"/></svg></button>
                            </div>
                        </div>
                    }
                ...
                {show && 
                //when show is false it shares social media div
                <div className="card_share">
                    ...
                    <div className="card_autoButtonShare">
                        <button className="buttonShareMobile" onClick={handlerClick}><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path fill="#6E8098" d="M15 6.495L8.766.014V3.88H7.441C3.33 3.88 0 7.039 0 10.936v2.049l.589-.612C2.59 10.294 5.422 9.11 8.39 9.11h.375v3.867L15 6.495z"/></svg></button>
                    </div>
                </div>  
                }
